        ...
        <div class="sycone-custom-footer">
            <div class="sycone-footer-content">
                ...
                <div class="sycone-social-icons">
                    <!-- Facebook -->
                    <a href="#" target="_blank" class="sycone-social-icon" title="Facebook">
                    ...
                    <!-- Instagram -->
                    <a href="#" target="_blank" class="sycone-social-icon" title="Instagram">
                        <svg viewBox="0 0 24 24">
                    ...
                    <!-- YouTube -->
                    <a href="#" target="_blank" class="sycone-social-icon" title="YouTube">
                        <svg viewBox="0 0 24 24">
                    ...
                    <!-- X (Twitter) -->
                    <a href="#" target="_blank" class="sycone-social-icon" title="X (Twitter)">
                        <svg viewBox="0 0 24 24">
                    ...
                    <!-- LinkedIn -->
                    <a href="#" target="_blank" class="sycone-social-icon" title="LinkedIn">
                        <svg viewBox="0 0 24 24">
...
// Optional: Add click handler to prevent default action for placeholder links
$(document).on('click', '.sycone-social-icon[href="#"]', function(e) {
    e.preventDefault();
    // You can add a console log or alert here if needed
    console.log('Social media icon clicked:', $(this).attr('title'));
});
